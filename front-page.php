    ...
    ?>
        ...
        <section id="home-header" class="home-custom-header">
            ...
            <div class="header-content">
                <a class="home-logo" href=<?php echo home_url(); ?> aria-label="Verdulux logo - Home Page Link"><?php include 'images/logo.php' ?></a>
                <?php
                        ...
                        ?>
                                <article class="vlx__home__testimonials--review testimonial-entry-<?php echo $testimonial_counter; ?>">
                                    ...
                                    foreach ($fields as $key => $value) {
                                        ...
                                        if ($key === 'name_') {
                                            echo '<h4 class="vlx__home__testimonials--reviewTitle">' . $value . '</h4>';
                                        }
                                        ...
                                        if ($key === 'testimonials_rating') {
                                            echo '<p class="vlx__home__testimonials--reviewRating">' . $value . " /5 " . '<span class="screen-reader-text">Star rating</span>' . '</p>';
                                        }
                                    }
                                    ?>
                                </article>
